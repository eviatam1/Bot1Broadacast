...
async def invite(ctx,):
  await ctx.send('https://discordapp.com/api/oauth2/authorize?client_id=512866748165390348&permissions=8&redirect_uri=https%3A%2F%2Fdiscord.gg%2FzvXmPhj&scope=bot')
